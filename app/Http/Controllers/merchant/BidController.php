...
class BidController extends Controller
{
    ...
    {
        $bids=Bidd::where('user_id',auth()->user()->id)->get();
        return view('merchant.seller_bidd.index',compact('bids'));
    }
    ...
    public function edit($bidds)
    {
        ...
        return view('merchant.seller_bidd.index',compact('bidds','bids'));
    }
    ...
    public function update(Request $request, $bidds)
    {
        ...
        return redirect()->route('seller_bidd.index');
    }
