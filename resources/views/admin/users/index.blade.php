                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.Budget.fields.name') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.Budget.fields.email') }}
                                    </th>
                                    <th>
                                        {{ trans('cruds.Budget.fields.email_verified_at') }}
                                    </th>
                                    <th>
                                        <!-- {{ trans('cruds.Budget.fields.approved') }} -->Status
                                    </th>
                                    <th>
                                        {{ trans('cruds.Budget.fields.roles') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
