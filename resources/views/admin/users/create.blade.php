                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.users.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('rejected') ? 'has-error' : '' }}">
                            <label for="rejected">{{ trans('cruds.Budget.fields.rejected') }}</label>
                            <input name="rejected" type="hidden" value="0">
                            <input value="1" type="checkbox" id="rejected" name="rejected" {{ old('rejected', 0) == 1 ? 'checked' : '' }}>
                            ...
                            @endif
                            <p class="helper-block">
                                {{ trans('cruds.Budget.fields.rejected_helper') }}
                            </p>
                        </div>
                        <!--  -->
