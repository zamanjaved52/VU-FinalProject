            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card  box-shadow-0">
                    ...
                    <div class="card-body pt-0">
                        <form class="form-horizontal needs-validation" method="post" action="{{ isset($bidds) ? route('seller_bidd.update',$bidds->id) : route('seller_bidd.store') }}" enctype="multipart/form-data">
                            @csrf
                            @if (isset($bidds))
                                @method('PUT')
                            @endif
                                ...
                                <table class="table mg-b-0 text-md-nowrap myTable " >
                                    ...
                                    @foreach($bids as $index => $pro)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-info" href="{{route('seller_bidd.edit',$pro->id)}}"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-sm btn-warning"  href="javascript:void(0);" onclick="$(this).find('form').submit();"><i class="fa fa-trash"></i>
                                                    <form action="{{ route('seller_bidd.destroy', $pro->id) }}"
                                                          method="post"
