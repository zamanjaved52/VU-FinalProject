...
<head>
    ...
    <link rel="icon"  href="{{asset('vu.jpg')}}">
...
<body class="sidebar-mini skin-purple" style="height: auto; min-height: 100%;">
    <div class="wrapper" style="height: auto; min-height: 100%;">
        <header class="main-header" style="background:black !important">
            <a href="#" class="logo bg-black">
                <span class="logo-mini" ><b>{{ trans('panel.site_title') }}</b></span>
                <span class="logo-lg bg-black">{{ trans('panel.site_title') }}</span>
            </a>
        ...
        <div class="content-wrapper" style="min-height: 960px; padding: 5%">
            @if(session('message'))
            ...
            @endif
          <span style="padding: 10%">  @yield('content')</span>
        </div>
        <footer class="main-footer text-center">
            <strong>Online Budget Planner Application</strong>
